...
const Board = () => {
  ...
  if (loadingImages)
    return <div className="pulse text-center mx-auto my-20 text-4xl">LOADING...</div>;
      ...
      <div className="mt-8 grid grid-cols-4 max-w-[800px] mx-auto gap-2 sm:gap-4 relative">
        {
          isGameOver
            ? <div
              ...
              className="blur-in backdrop-blur-sm absolute inset-2 md:inset-4 rounded-xl bg-black/70 grid place-items-center text-center"
            >
